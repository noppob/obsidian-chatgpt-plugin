...
- 💬 **Interactive Conversation Mode** (NEW!) - Have multi-turn conversations in a modal dialog
...
### Custom Prompt (Interactive Mode) 🆕

1. **Select text** in your note
2. Press `Ctrl/Cmd + P`
3. Search for **"Ask ChatGPT with custom prompt"**
4. A **conversation modal** opens with your selected text as context
5. Type your first question and click **"送信" (Send)**
6. ChatGPT responds in the modal
7. **Continue the conversation** by asking follow-up questions
8. When done, click **"挿入して閉じる" (Insert and Close)**
9. ✅ The entire conversation is inserted into your note!

**Benefits of Interactive Mode:**
- 💬 Have natural back-and-forth conversations
- 🧠 Context is preserved across multiple questions
- 📝 Review the whole conversation before inserting
- ⚡ No need to re-select text for follow-up questions
...
**Interactive Deep Dive (NEW!):**
```
Select: "The mitochondria is the powerhouse of the cell"
Command: Ask ChatGPT with custom prompt

Q1: "What does this mean exactly?"
A1: [Explanation of mitochondria function]

Q2: "Can you give me a real-world analogy?"
A2: [Analogy comparing mitochondria to power plants]

Q3: "What happens if mitochondria malfunction?"
A3: [Information about mitochondrial diseases]

Click "挿入して閉じる" → All Q&A pairs inserted into note!
```
