...
var ChatGPTSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Model").setDesc("Select ChatGPT model").addDropdown(
      (dropdown) => dropdown.addOption("gpt-5-mini", "GPT-5 Mini (Latest, Fastest)").addOption("gpt-5", "GPT-5 (Latest)").addOption("gpt-4o", "GPT-4o (Recommended)").addOption("gpt-4o-mini", "GPT-4o Mini (Faster, Cheaper)").addOption("gpt-4-turbo", "GPT-4 Turbo").addOption("gpt-4", "GPT-4").addOption("gpt-3.5-turbo", "GPT-3.5 Turbo").setValue(this.plugin.settings.model).onChange(async (value) => {
