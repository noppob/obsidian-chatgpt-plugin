	...
	display(): void {
		...
		new Setting(containerEl)
			...
			.addDropdown((dropdown) =>
				dropdown
					.addOption('gpt-5.2', 'GPT-5.2 (Latest, Most Capable)')
					.addOption('gpt-5.1', 'GPT-5.1 (Balanced)')
					.addOption('gpt-5.0', 'GPT-5.0 (Budget-Friendly)')
					.addOption('gpt-5-mini.2', 'GPT-5 Mini 5.2 (Fast, Latest)')
					.addOption('gpt-5-mini.1', 'GPT-5 Mini 5.1 (Fast, Mid)')
					.addOption('gpt-5-mini.0', 'GPT-5 Mini 5.0 (Fast, Budget)')
